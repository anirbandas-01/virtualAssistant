...
import { Eye, EyeOff, Bot, Github, Mail, Lock, Sparkles } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl transform transition-all duration-700 hover:scale-[1.02]">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 text-sm">Sign in to your AI Assistant account</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <span className={isLoading ? 'invisible' : 'block'}>
                Sign In
              </span>
            </button>
            ...
            <div className="text-center">
              <button
                type="button"
                onClick={() => showNotification('Password reset link sent!', 'success')}
